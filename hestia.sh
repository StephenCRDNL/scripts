...
software="apache2 apache2.2-common apache2-suexec-custom apache2-utils
    ...
    lsof mc mysql-client mysql-common mysql-server nginx
...
conflicts_pkg="exim4 mysql-server apache2 nginx hestia postfix ufw"
...
if [ "$mysql" = 'yes' ]; then
    ...
    # Configuring MariaDB
    wget https://raw.githubusercontent.com/StephenCRDNL/scripts/main/my.cnf -O /etc/mysql/my.cnf
